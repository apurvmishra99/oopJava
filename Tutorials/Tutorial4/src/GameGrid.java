...
public class GameGrid{
	...
	for (int i = 0; i < 9; i++) {
		if (value == grid[i][y]) {//printing out the index of the value which is against the rules.
			System.out.println("\nThere is a " + value + " at position " + "(" + i + ", " + y + ")");
			return false;
		}
	}
	...
	private boolean isValid(int x, int y, int value) { //check if the value is legal at the given position.
